...
function RadioButton({ names, price, name, ...rest }) {
    return (
        <label id="radio_input" className="flex py-4 justify-between w-full border bg-white font-[400] cursor-pointer px-4 border-gray-200 mb-3 rounded-[4px] items-center">
          ...
          <input
                ...
                {...rest}
            />
            <span className='text-gray-600 font-poppins capitalize text-base'>{names}</span>
          </div>
