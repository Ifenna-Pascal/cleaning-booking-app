    ...
    <div className="md:text-left text-center  block ">
      ...
      <div className='flex px-4 md:px-0  my-4 py-2 md:py-0 items-center'>
        ...
        <div className='flex items-start flex-col'>
          <h2 className="block text-white leading-[1rem]  font-semibold font-outfit capitalizev text-[1em]">{name}</h2>
          <p className="text-gray-300 text-left md:text-center font-[400] text-base max-w-[500px] " >{title}</p>
        </div>
      </div>
    </div>
  )
