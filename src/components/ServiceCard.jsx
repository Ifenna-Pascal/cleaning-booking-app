  ...
  return (
    <div className='w-full min-h-[400px] cursor-pointer duration-500 scale_up bg-white rounded-xl shadow-lg'>
        ...
        <div className='flex flex-col py-6 items-center justify-center'>
            ...
            <span className="text-text_primary text-center font-outfit text-[1.2em] font-semibold mb-4">{header}</span>
            <span className='text-center mb-3 text-gray-600 font-outfit text-base'>{content}</span>
