  ...
  return (
    <div>
           <Hero bg="bg-landscape">
            ...
            <h1 className='text-white leading-[1.5em] lg:leading-[1em] font-poppins tracking-wide text-center  font-bold text-[2.3em]  lg:text-[2.5em]'>{id && id.charAt(0).toUpperCase() + id.slice(1)} Cleaning <br /> Service</h1>
