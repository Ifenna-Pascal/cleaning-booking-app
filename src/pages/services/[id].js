  ...
  return (
    <div>
           <Hero bg="bg-landscape">
            ...
            <h1 className='text-white leading-[1em] lg:leading-[1.3em] font-poppins tracking-wide text-center  font-bold text-[1.7em]  lg:text-[2.5em]'> {serviceDetails?.name}  Service</h1>
