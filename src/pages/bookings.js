  ...
  return (
    <div>
         <Hero bg="bg-bookingHero">
          ...
          <p className=" px-3 max-w-[700px] tracking-wider md:px-0 text-lg text-center  text-[#ebe7e7] leading-8 mt-4 font-poppins">For our services you can book us. Fil the form, schedule a date, make payemnts we would deliver </p> </div>
        </Hero> 
        <BookingSection />
        <BookQuote />
