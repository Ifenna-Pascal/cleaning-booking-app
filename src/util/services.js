export const services = [
  ...
  },
  {
    ...
    content:
      'Do you have a newly constructed building In need of industrial cleaning,or a newly renovated space that needs to be revamped?, well you found us!. At crystal home deterge we are fully committed and our highly professional team are ready to clean for you.',
  },
  {
    id: 4,
    name: 'Deep Cleaning',
    ...
    content:
      'There’s clean and there’s SUPER CLEAN!. Whenever you need your space sparkling,we are your one stop! committed to giving you a crystal experience,we are ready to go deep into all corners,vents and details,clean all dirts,remove all stains and ready to give you the sparkle you desire ',
  },
  {
    id: 5,
    ...
    header:
      'Maintain a healthy home  environment at your comfort and zero stress.',
    content:
      'Are you constantly burdened with organizing your wardrobe? Or eating unhealthy because of a disorganized pantry?.Well we are your solution! At crystal home deterge limited,we are swear by four concrete steps; edit,categorize,maintain and contain. Our team is well equipped and acquainted to help you maintain your space and improve your lifestyle.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    header:
      'Avoid sharing space with pests and rodents. Theyu can be eliminated',
