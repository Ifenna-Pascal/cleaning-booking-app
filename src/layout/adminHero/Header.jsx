  ...
  return (
    <div className="py-4 px-16 w-full mx-auto hidden lg:flex items-center justify-between min-h-[60px] rounded-[6px] shadow-sm">
      ...
      <div className="flex flex-col ">
        <h1 className="leading-[16px] text-gray-600 font-semibold text-[16px]">
          Welcome Admin!🎉
        </h1>
...
export const HeaderTabs = ({ text, type, status, ...rest }) => {
  return (
    <button
      className={`${
        status === type ? 'bg-secondary text-white' : 'text-gray-700'
      } border mr-4 hover:translate-x-1  border-gray-200 px-6 py-2 cursor-pointer font-poppins  hover:border-secondary duration-200  rounded-[8px]  flex items-center justify-center`}
      {...rest}
    >
      {text}
    </button>
