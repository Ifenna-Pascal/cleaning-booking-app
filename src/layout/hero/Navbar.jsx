  ...
  return (
    <nav className='bg-[#fff] py-4 px-8  flex  top-[2rem] md:top-[4rem] justify-between relative max-w-[95%] mx-auto lg:max-w-[1250px] w-full shadow-lg  items-center h-[60px] md:h-[80px]  rounded-lg'>
      ...
      <div className="justify-self-end hidden md:flex self-end lg:flex space-x-10">
        ...
        <Link href="/bookings"><button className="bg-secondary justify-self-end self-end border-none flex items-center py-3 px-10 font-outfit cursor-pointer hover:cursor-pointer hover:opacity-95 hover:-translate-x-[6px] hover:text-gray-100 duration-300 text-white font-semibold rounded-md justify-center">Book Now</button></Link>
      </div>
    </nav >
  )
}
