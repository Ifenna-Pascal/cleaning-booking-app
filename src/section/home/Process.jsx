  ...
  return (
    <div className={`min-h-[70vh]  w-full bg-processTwo  bg-no-repeat bg-cover flex  flex-col md:flex-row bg-center bg-fixed relative`}>
       <div className='max-w-[1250px] w-full py-16  flex flex-col items-center justify-center relative mx-auto'>
          <h1 className="text-center pb-12 text-white font-poppins text-[1.8em] md:text-[2.5em] leading-[2rem] md:leading-[4rem] font-semibold capitalize">Simple 3 Steps <br /> Processs</h1>
          <div className="flex justify-between  md:mx-0 space-y-8 md:space-y-0 flex-col md:flex-row md:items-center">
