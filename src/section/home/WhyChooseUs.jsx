    ...
    <div className="bg-[#e2e7f6]">
      <div className='max-w-[1250px] py-8 pb-12 flex justify-center w-full h-full flex-col md:flex-row relative mx-auto'>
        <div className='basis[60%] px-4 md:pl-8 md:pr-0 py-6 w-full'>
          ...
          <div className='grid lg:grid-cols-2 lg:py-8 pb-16 gap-6 max-w-[700px]'>
        ...
        <div className='-mt-[60px] lg:-mt-[250px] rounded-xl mx-[1rem] lg:min-w-[420px] flex flex-col pt-8 md:pt-8 px-4 items-start shadow-lg border-lg bg-white'>
