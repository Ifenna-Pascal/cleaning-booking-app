...
function Review({
  ...
  return (
    <div className="md:p-6 rounded-[10px] ">
      <h2 className="text-left mb-2 font-poppins text-gray-800 font-semibold text-base">
        Booking Summary{' '}
      </h2>
      ...
      <div className="py-3 flex flex-col space-y-2">
        <div className="py-3 flex flex-col space-y-2">
          <h2 className="text-base text-gray-800 font-poppins font-semibold text-left">
            Personal Info
          </h2>
          <span className="text-base font-poppins text-gray-500 ">
      ...
      {loading && (
        <div className="flex w-full items-center justify-center">
          <div className="flex  animate-spin items-center justify-center bg-primary h-6 w-6"></div>
        </div>
      )}
    </div>
  );
