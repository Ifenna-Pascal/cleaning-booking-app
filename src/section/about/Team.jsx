...
function Team() {
  return (
    <div className="bg-[#e2e7f6]">
      <div className='max-w-[1200px] min-h-[600px] flex flex-col w-full h-full items-start lg:py-20  relative mx-auto'>
        <div className='block flex items-center flex-col w-full text-center'>
        ...
        <div className="grid grid-cols-3 gap-8 py-8 w-full">
          {
            workers.map(x => (
