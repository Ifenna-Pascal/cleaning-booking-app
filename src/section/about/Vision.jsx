            ...
            <div className='lg:max-w-[1200px] min-h-[600px] flex flex-col w-full h-full items-center lg:items-start py-16 lg:py-24  relative mx-auto'>
                <div className='grid grid-cols-1 lg:grid-cols-3 '>
                    <div className='lg:col-span-2 flex  flex-col py-12 px-4 lg:px-0  lg:max-w-[90%]'>
                        ...
                        <p className='py-3 text-base text-center lg:text-left text-gray-500 px-4 lg:px-0'>We have spanned across several fields and sectors, providing quality cleaning and management services to our clients at several levels.</p>
                    ...
                    <div className='col-span-1 w-full lg:h-full h-[450px] px-4 '>
                        <img src={Images.imageEight} alt="our vission" className="w-full h-full rounded-[20px] object-cover" />
                    </div>
                </div>
            </div>
        </div >
