            ...
            <div className='lg:max-w-[1200px] min-h-[600px] flex flex-col w-full h-full items-center lg:items-start py-16 lg:py-24  relative mx-auto'>
                <div className='grid grid-cols-1 lg:grid-cols-3 '>
                    <div className='lg:col-span-2 flex  flex-col py-12 px-4 lg:px-0  lg:max-w-[90%]'>
                        <h1 className='lg:text-left text-center text-2xl lg:text-4xl font-poppins leading-[1.3em] lg:leading-[1.5em] text-black font-semibold'>We have been providing cleaning <br />services for more than a decade.</h1>
                        <p className='py-6 text-lg text-center lg:text-left text-gray-500 px-4 lg:px-0 font-[500]'>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Aenean lacinia bibendum nulla sed consectetur. Nulla vitae elit libero, a pharetra augue. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.</p>
